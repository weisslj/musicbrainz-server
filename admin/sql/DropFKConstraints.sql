...
ALTER TABLE echoprint DROP CONSTRAINT echoprint_fk_version;
...
ALTER TABLE recording_echoprint DROP CONSTRAINT recording_echoprint_fk_echoprint;
ALTER TABLE recording_echoprint DROP CONSTRAINT recording_echoprint_fk_recording;
